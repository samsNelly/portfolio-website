...
const AboutContent = () => {
  return (
    <div className="about">
        <div className="left">
            <h1>Who am I?</h1>
            <p>I am Samuel Nelson, aspiring developer with a love for leveraging technology to drive business success.</p>
            <p>I am an undergratuate teaching assistant for the Computer Systems class at the University of Minnesota, College of Science and Engineering. Here, I instruct 2 lab sections of 30 students, aiding in the development of students' programming skills in C.</p>
